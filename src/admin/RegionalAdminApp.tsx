        ...
        <Route element={<AdminGuard />}>
          <Route element={<AdminLayout />}>
            ...
            <Route
              ...
              element={<OperatorRequestListPage />}
            />
            <Route
            ...
            <Route
              ...
              element={<PublishedContentListPage />}
            />
            <Route
              path="contents/published/:contentId"
              element={<PublishedContentDetailPage />}
            />
            <Route path="contents/:contentId" element={<ContentDetailPage />} />
            <Route
              path="content-revisions"
              element={<ContentRevisionListPage />}
            />
            <Route
            ...
            />
            <Route
              path="withdrawal-requests/:requestId"
              element={<WithdrawalDetailPage />}
            />
            <Route path="sessions" element={<SessionListPage />} />
            <Route path="sessions/:sessionId" element={<SessionDetailPage />} />
            <Route
              path="session-revisions"
              element={<SessionRevisionListPage />}
            />
            <Route
              path="session-revisions/:revisionId"
              element={<SessionRevisionDetailPage />}
            />
            <Route path="qr-exceptions" element={<QrExceptionListPage />} />
            <Route
              path="qr-exceptions/:exceptionId"
