...
export function statusTone(value: string) {
  if (["PUBLISHED", "APPROVED", "SCHEDULED", "CONFIRMED", "SUCCEEDED", "COMPLETED"].includes(value))
    return "success";

  if (
    ["PENDING", "PENDING_REVIEW", "EDIT_REQUESTED", "REVIEW_UNKNOWN", "PROCESSING"].includes(value)
  )
    return "pending";
