...
export function getOperatorContents(signal?: AbortSignal) {
  return apiRequest<{ contents: OperatorContentSummary[] }>("/api/v1/operator/contents", {
    signal,
  });
}
...
export function getOperatorContentSessions(contentId: string, signal?: AbortSignal) {
...
export function getOperatorSessionReservations(
  ...
  return apiRequest<OperatorSessionReservationsResponse>(
    withQuery(`/api/v1/operator/contents/${encodeURIComponent(contentId)}/reservations`, {
      sessionId,
    }),
    { signal },
  );
...
export function searchOperatorReservation(reservationNo: string, signal?: AbortSignal) {
...
export function createContentRevision(contentId: string, request: ContentRevisionFields) {
...
export function updateContentRevision(revisionId: string, request: ContentRevisionFields) {
...
export function createOperatorSession(contentId: string, request: SessionFields) {
...
export function requestSessionChange(sessionId: string, request: SessionFields) {
...
export function cancelOperatorSession(sessionId: string, cancellationReason: string) {
