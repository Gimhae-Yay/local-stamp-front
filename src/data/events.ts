...
export type ReservationStatus = '예약 가능' | '예약 마감' | '마감 임박'
...
export const events: LocalEvent[] = [
  { id: 'gaya-culture', title: '김해 가야문화 체험', location: '김해시 가야의길 190', address: '김해문화회관 1층', date: '8월 17일 (일)', time: '10:00–12:00', status: '진행 중', reservationStatus: '예약 가능', seats: 4, description: '김해의 가야 문화를 직접 보고, 만들고, 들어보는 주말 체험 프로그램' },
  { id: 'daeseong-tomb', title: '대성동 고분 박물관 해설', location: '김해시 가야안길 126', address: '대성동고분박물관', date: '8월 17일 (일)', time: '14:00–16:00', status: '진행 중', reservationStatus: '예약 가능', seats: 8, description: '전시 해설과 함께 가야 왕국의 역사를 만나는 시간' },
  { id: 'nakdong-eco', title: '낙동강 생태 탐방', location: '김해시 생태원 일대', address: '김해시 생태원', date: '8월 16일 (토)', time: '14:00–16:00', status: '곧 시작', reservationStatus: '예약 가능', seats: 12, description: '낙동강의 생태와 계절 풍경을 걸으며 알아보는 탐방' },
  { id: 'buncheong-class', title: '분청도자기 원데이 클래스', location: '김해시 진례면', address: '진례문화센터', date: '8월 23일 (토)', time: '13:00–15:00', status: '곧 시작', reservationStatus: '마감 임박', seats: 6, description: '나만의 분청도자기를 만들어 보는 원데이 클래스' },
  { id: 'bonghwang-walk', title: '봉리단길 로컬 산책', location: '김해시 봉황동', address: '봉황동 주민센터', date: '8월 24일 (일)', time: '10:30–12:00', status: '곧 시작', reservationStatus: '예약 가능', seats: 15, description: '동네 이야기와 로컬 상점을 만나는 느린 산책' },
  { id: 'gaya-night', title: '가야왕도 야간 투어', location: '김해시 대성동', address: '대성동고분박물관', date: '8월 30일 (토)', time: '19:00–21:00', status: '곧 시작', reservationStatus: '마감 임박', seats: 2, description: '밤의 가야왕도를 해설과 함께 돌아보는 투어' },
  ...
  { id: 'jeon-dong-pottery', title: '김해 전통주 빚기', location: '김해시 삼계동', address: '삼계생활문화센터', date: '9월 12일 (금)', time: '15:00–17:00', status: '곧 시작', reservationStatus: '마감 임박', seats: 5, description: '지역 쌀로 전통주를 빚고 맛보는 체험' },
  ...
  { id: 'clay-architecture', title: '클레이아크 건축 체험', location: '김해시 진례면', address: '클레이아크 김해미술관', date: '9월 28일 (일)', time: '11:00–12:30', status: '곧 시작', reservationStatus: '마감 임박', seats: 4, description: '흙과 건축을 연결해 나만의 모형을 만드는 체험' },
  ...
  { id: 'museum-night', title: '박물관의 밤, 가야 이야기', location: '김해시 구산동', address: '국립김해박물관', date: '10월 18일 (토)', time: '18:30–20:00', status: '곧 시작', reservationStatus: '마감 임박', seats: 3, description: '야간 개장 시간에 만나는 가야 역사 해설' },
